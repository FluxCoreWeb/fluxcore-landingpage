...
:start
@start "" "League of Legends.exe" "spectator spectator.br.lol.riotgames.com:80 4ijJ1y2kAdevttwz/TVzPrDwGHnekygc 2662827506 BR1" -UseRads -GameBaseDir=.. "-Locale=%locale%" -SkipBuild -EnableCrashpad=true -EnableLNP
goto exit
